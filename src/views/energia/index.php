...
<div class="space-y-6">
    ...
    <form action="index.php?page=energia" method="POST" class="space-y-4 bg-white p-6 rounded-lg shadow-lg">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <form action="index.php" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            <input type="hidden" name="page" value="energia">
            <div>
            ...
            <div class="flex items-end">
                ...
                <a href="index.php?page=energia" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-md shadow-sm ml-2">
                    Limpar
                </a>
            </div>
        </form>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php foreach ($registros as $registro): ?>
                        <tr id="row-<?= htmlspecialchars($registro['id_energia']) ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button onclick="editarRegistro(<?= $registro['id_energia'] ?>)" class="text-indigo-600 hover:text-indigo-900 mr-2">Editar</button>
                                <button onclick="excluirRegistro(<?= $registro['id_energia'] ?>)" class="text-red-600 hover:text-red-900">Excluir</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<script>
    ...
    function editarRegistro(id) {
        if (confirm('Deseja editar este registro? A página será recarregada com os dados.')) {
    ...
    function excluirRegistro(id) {
        if (confirm('Tem certeza que deseja excluir este registro?')) {
            ...
            form.method = 'POST';
            form.action = 'index.php?page=energia';
            form.innerHTML = `
