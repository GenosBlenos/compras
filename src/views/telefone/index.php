...
<div class="space-y-6">
    ...
    <form action="index.php?page=telefone" method="POST" class="space-y-4 bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" name="numero" id="numero" class="mt-1 block w-full rounded-md border-gray-400 border-2 shadow-sm focus:border-[#072a3a] focus:ring focus:ring-[#072a3a] focus:ring-opacity-50">
            </div>
            <div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Registros de Telefonia Fixa</h2>
                    ...
                    <?php foreach ($registros as $registro): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button onclick="editarRegistro(<?= $registro['id_telefone'] ?>)" class="text-indigo-600 hover:text-indigo-900 mr-2">Editar</button>
                                <button onclick="excluirRegistro(<?= $registro['id_telefone'] ?>)" class="text-red-600 hover:text-red-900">Excluir</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
